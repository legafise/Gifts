...
import com.epam.esm.dao.mapper.MJCTagMapperImpl;
...
public class MJCCertificateExtractorImpl implements ResultSetExtractor<List<Certificate>> {
    ...
    private final MJCTagMapperImpl tagMapper;

    @Autowired
    public MJCCertificateExtractorImpl(MJCTagMapperImpl tagMapper) {
