...
import com.epam.esm.dao.extractor.MJCUserExtractorImpl;
...
public class JdbcTemplateMJCUserDao implements MJCUserDao {
    ...
    private final MJCUserExtractorImpl userExtractor;
    private final JdbcTemplate jdbcTemplate;

    @Autowired
    public JdbcTemplateMJCUserDao(MJCUserExtractorImpl userExtractor, JdbcTemplate jdbcTemplate) {
