...
@Component
public class MJCCertificateValidatorImpl implements MJCCertificateValidator {
    ...
    public MJCCertificateValidatorImpl() {
    ...
    public void validateCertificate(Certificate certificate) {
        if (certificate == null) {
            throw new MJCInvalidEntityException(Certificate.class, CERTIFICATE_IS_NULL_MESSAGE);
        }
        ...
        if (!invalidValues.isEmpty()) {
            throw new MJCInvalidEntityException(Certificate.class, collectCause(invalidValues));
        }
    }
