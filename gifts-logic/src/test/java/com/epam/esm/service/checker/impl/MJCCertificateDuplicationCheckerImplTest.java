...
class MJCCertificateDuplicationCheckerImplTest {
    private MJCCertificateDuplicationCheckerImpl certificateDuplicationChecker;
    ...
    void setUp() {
        ...
        certificateDuplicationChecker = new MJCCertificateDuplicationCheckerImpl(certificateDao);
